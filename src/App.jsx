...
import './App.css'
import sqlInjectionImg from '../docs_galseb/imagenes_galseb/Inyeccion_SQL.png'
import xssImg from '../docs_galseb/imagenes_galseb/XSS.png'
import cmdInjectionImg from '../docs_galseb/imagenes_galseb/Inyeccion_de_Comando.png'
    ...
    <div className="page active">
      ...
      <div className="vuln-card">
        ...
        <div className="vuln-body">
          ...
          <div className="payload-block"><img src={sqlInjectionImg} alt="SQL Injection Payload" style={{ maxWidth: '100%', height: 'auto' }} /></div>
    ...
    <div className="page active">
      ...
      <div className="vuln-card">
        ...
        <div className="vuln-body">
          ...
          <div className="payload-label">// payload utilizado</div>
          <div className="payload-block"><img src={xssImg} alt="XSS Payload" style={{ maxWidth: '100%', height: 'auto' }} /></div>
          <h3>Impacto en ConectaTel</h3>
    ...
    <div className="page active">
      ...
      <div className="vuln-card">
        ...
        <div className="vuln-body">
          ...
          <div className="payload-block"><img src={cmdInjectionImg} alt="Command Injection Payload" style={{ maxWidth: '100%', height: 'auto' }} /></div>
          <h3>Impacto en ConectaTel</h3>
